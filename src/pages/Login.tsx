            ...
            <div className="auth-layout">
                ...
                >
                    ...
                    <div className="social-grid">
                        ...
                        {/* Telegram — custom overlay over hidden official widget */}
                        {loadingSource === 'telegram'
                            ...
                            : <div className="tg-widget-container">
                                {/* Visible label — pointer-events: none so clicks fall through */}
                                <div className="tg-btn-overlay">
                                    ...
                                    <span>{uz ? 'Telegram orqali kirish' : 'Login with Telegram'}</span>
                                </div>
                                {/* Invisible Telegram iframe — sits on top to capture the actual click */}
                                <div ref={tgContainerRef} className="tg-widget-inner" />
                              </div>
                        }
                    </div>
